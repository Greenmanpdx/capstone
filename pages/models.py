...
class NPC(Character):
    ...
    melee = models.CharField(max_length=1024, null=True, blank=True)
    ...
    feats = models.CharField(max_length=1024, null=True, blank=True)
    ...
    special_quality = models.CharField(max_length=1024, null=True, blank=True)
